...
public interface UserRepository extends PagingAndSortingRepository<TUser, String>, JpaRepository<TUser, String> {
    ...
    @Query("select new TUser(u.userid,u.name,u.avatar,r.name) from TUser u,TUserAndRole ur,TRole r where u.userid = ur.userid and ur.roleid = r.id and ur.agentid=?1 or ur.roleid=null")
