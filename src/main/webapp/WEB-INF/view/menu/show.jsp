                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-xs btn-success"
                                        onclick="javascript:window.location.href='<%=basePath%>/platform/course?projectid=${project.id}'">
                                    课程
                                </button>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="<%=basePath%>/platform/project/createStudyGroupJsp?projectid=${project.id}">创建小组</a>
                                        </li>
                                        <li><a href="<%=basePath%>/platform/group?projectid=${project.id}">已创建的小组</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
